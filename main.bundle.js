...
/***/ function(module, exports, __webpack_require__) {
	...
	// require('./vote');
	var NewTD = __webpack_require__(15);
	var newTDBoxCreator = __webpack_require__(16);
	...
	function updateTD(id, attribute, newValue) {
	  var currentTD = storage.getTD(id);
	...
	function resetTDCount() {
	  var storedTDCount = storage.getTDCount();
	...
	function loadStorage() {
	  for (var i = 0; i < localStorage.length; i++) {
	    if (localStorage.key(i) !== 'tdCountTracker') {
	      var storedInfo = storage.getTD(localStorage.key(i));
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "module.exports body {\n  color: #F00; }\n", ""]);
...
/***/ function(module, exports) {
	...
	module.exports = {
	  setTD: function setTD(id, object) {
	    localStorage.setItem(id, JSON.stringify(object));
	  },

	  getTD: function getTD(id) {
	    return JSON.parse(localStorage.getItem(id));
	  },

	  removeTD: function removeTD(id) {
	    localStorage.removeItem(id);
	  },

	  setTDCount: function setTDCount(id) {
	    localStorage.setItem('tdCountTracker', id);
	  },

	  getTDCount: function getTDCount() {
