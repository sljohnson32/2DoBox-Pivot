  ...
  tdHTML: function(obj) {
    if (obj.completed === true) {
      return $("<article id=" + obj.id + " class='td-box completed-td'>"
          + "<div class='flexer'>"
            + "<h2 class='td-title' name='td-title'  contenteditable='true' maxlength='120'>" + obj.title + "</h2>"
          + "</div>"
          + "<p class='td-task' name='task-title' contenteditable='true' maxlength='120'>" + obj.task + "</p>"
          + "<div class='importance-container'>"
          + "<h4 class='importance-rating'>" + obj.importance + "</h4></div></article>");
      } else return $("<article id=" + obj.id + " class='td-box td-incomplete'>"
        + "<div class='flexer'>"
          + "<h2 class='td-title' contenteditable='true' maxlength='120'>" + obj.title + "</h2>"
        + "</div>"
        + "<p class='td-task' contenteditable='true' maxlength='120'>" + obj.task + "</p>"
        + "<div class='importance-container'>"
        + "<h4 class='importance-rating'>" + obj.importance + "</h4></div></article>"
      );
  },
