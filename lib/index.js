...
function showTenToDos() {
  $('.td-box').hide();
  if (tdLoadComplete === true) {
    $('.td-box').slice(0, 10).show();
  } else {
    $(".td-incomplete").slice(0, 10).show();
  }
}

$(document).ready(function(){
  utilities.loadStorage(tdLoadComplete);
...
//we need to figure out how to ONLY show visible TDs when completed TDs are not shown...right now, both types of TDs are displaying when you hit the filter
