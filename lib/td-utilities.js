...
module.exports = {
  ...
  getLoadCompletesStatus: function() {
    return loadCompleteTDs;
  },
  ...
  toggleShowHide: function(clickedButtonImportance, storedTDImportance, storedTDElement, storedTD) {
    if (loadCompleteTDs === false && clickedButtonImportance === storedTDImportance && storedTD.completed === false) {
      storedTDElement.show();
      } else if (loadCompleteTDs === true && clickedButtonImportance === storedTDImportance) {
        storedTDElement.show();
        } else storedTDElement.hide();
    }
